...
1. Back End integration.
    ...
    * API to create and list recipes
    * API to vote for a recipe (user should be able to vote only once for a recipe)
2. Axios
    * A class to handle api services avoiding not reusable API calls
3. Env files
    * env files for prod, homo, dev to avoid hardcoded configurations.  
4. Redux
    * Redux could reduce components parametrization
    * Redux could make more easy to test API calls 
